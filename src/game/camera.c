...
s16 update_default_camera(struct Camera *c) {
    ...
    if (sMarioCamState->cameraEvent == CAM_EVENT_START_INTRO) {
    ...
    if (cutscene == 0) {
        ...
        switch (sMarioCamState->cameraEvent) {
            ...
            case CAM_EVENT_START_GRAND_STAR:
                ...
                break;
			case CAM_EVENT_START_PYRAMID_EXPLODE:
			    cutscene = CUTSCENE_SSL_PYRAMID_EXPLODE;
				break;
...
struct CameraTrigger sCamRR[] = {
	{1, cam_rr_enter_building, 14, 4362, -3679, 1082, 689, 1082, 0x4000},
	{1, cam_rr_exit_building_side, 5, 4121, -2325, 242, 433, 368, 0x4000},
	NULL_TRIGGER
};
