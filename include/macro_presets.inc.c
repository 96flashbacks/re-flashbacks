...
static struct MacroPreset sMacroObjectPresets[] = {
    ...
    /* macro_empty_2                     */ { bhvYellowCoin, MODEL_YELLOW_COIN, 0 },
    /* macro_empty_3                     */ { bhvYellowCoin, MODEL_YELLOW_COIN, 0 }, // unused
    ...
    /* macro_empty_53                    */ { bhvYellowCoin, MODEL_YELLOW_COIN, 0 },
    /* macro_empty_54                    */ { bhvYellowCoin, MODEL_YELLOW_COIN, 0 },
