...
static const Gfx ssl_seg7_dl_07021638[] = {
    ...
    gsSPLight(&ssl_seg7_lights_0701FD78.l, 1),
    gsSPLight(&ssl_seg7_lights_0701FD78.a, 2),
	gsSPVertex(ssl_seg7_vertex_07020A20 + 0, 15, 0),
	...
	gsSPVertex(ssl_seg7_vertex_07020A20 + 15, 14, 0),
	gsSP1Triangle(0, 1, 2, 0),
	gsSP1Triangle(0, 3, 1, 0),
	gsSP1Triangle(4, 5, 6, 0),
	...
	gsSPVertex(ssl_seg7_vertex_07020A20 + 29, 16, 0),
	gsSP1Triangle(0, 1, 2, 0),
	gsSP1Triangle(0, 3, 1, 0),
	gsSP1Triangle(4, 5, 6, 0),
	gsSP1Triangle(4, 6, 7, 0),
	...
	gsSPVertex(ssl_seg7_vertex_07020A20 + 45, 16, 0),
	gsSP1Triangle(0, 1, 2, 0),
	...
	gsSPVertex(ssl_seg7_vertex_07020A20 + 61, 8, 0),
	gsSP1Triangle(0, 1, 2, 0),
...
static const Gfx ssl_seg7_dl_07021870[] = {
    ...
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
	gsSPVertex(ssl_seg7_vertex_07020EB0 + 0, 14, 0),
	gsSP1Triangle(0, 1, 2, 0),
	...
	gsSPVertex(ssl_seg7_vertex_07020EB0 + 14, 12, 0),
	gsSP1Triangle(0, 1, 2, 0),
	gsSP1Triangle(0, 3, 1, 0),
	gsSP1Triangle(4, 5, 6, 0),
	gsSP1Triangle(4, 7, 5, 0),
