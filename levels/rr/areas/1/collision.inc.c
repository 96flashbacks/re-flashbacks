...
const Collision rr_seg7_collision_level[] = {
    ...
    COL_TRI_STOP(),
    COL_SPECIAL_INIT(2),
    SPECIAL_OBJECT_WITH_YAW(/*preset*/ special_level_geo_10, /*pos*/  2628,  -143, -1611, /*yaw*/    0), // platforms
    SPECIAL_OBJECT_WITH_YAW(/*preset*/ special_level_geo_14, /*pos*/  3917,   624, -1133, /*yaw*/    0), // rainbow path
    COL_END(),
};
