...
static const LevelScript script_func_local_4[] = {
    ...
    OBJECT_WITH_ACTS(/*model*/ MODEL_EXCLAMATION_BOX, /*pos*/  1050,  550,  6200, /*angle*/ 0,   0, 0, /*bhvParam*/ BPARAM2(EXCLAMATION_BOX_BP_KOOPA_SHELL), /*bhv*/ bhvExclamationBox, /*acts*/ ALL_ACTS),
	OBJECT_WITH_ACTS(/*model*/ MODEL_RED_COIN,              /*pos*/     0,  307, -2085, /*angle*/ 0, 0, 0,   /*bhvParam*/ 0, /*bhv*/ bhvRedCoin,                /*acts*/ ACT_4),
    OBJECT_WITH_ACTS(/*model*/ MODEL_RED_COIN,              /*pos*/  6326,  686, -6580, /*angle*/ 0, 0, 0,   /*bhvParam*/ 0, /*bhv*/ bhvRedCoin,                /*acts*/ ACT_4),
	OBJECT_WITH_ACTS(/*model*/ MODEL_RED_COIN,              /*pos*/     0,   46, -7400, /*angle*/ 0, 0, 0,   /*bhvParam*/ 0, /*bhv*/ bhvRedCoin,                /*acts*/ ACT_4),
	OBJECT_WITH_ACTS(/*model*/ MODEL_RED_COIN,              /*pos*/ -3133,  230, -2126, /*angle*/ 0, 0, 0,   /*bhvParam*/ 0, /*bhv*/ bhvRedCoin,                /*acts*/ ACT_4),
	OBJECT_WITH_ACTS(/*model*/ MODEL_RED_COIN,              /*pos*/ -2333,  653,   886, /*angle*/ 0, 0, 0,   /*bhvParam*/ 0, /*bhv*/ bhvRedCoin,                /*acts*/ ACT_4),
	OBJECT_WITH_ACTS(/*model*/ MODEL_RED_COIN,              /*pos*/ -6780,  275, -6766, /*angle*/ 0, 0, 0,   /*bhvParam*/ 0, /*bhv*/ bhvRedCoin,                /*acts*/ ACT_4),
	OBJECT_WITH_ACTS(/*model*/ MODEL_RED_COIN,              /*pos*/ -5100,  540, -4070, /*angle*/ 0, 0, 0,   /*bhvParam*/ 0, /*bhv*/ bhvRedCoin,                /*acts*/ ACT_4),
	OBJECT_WITH_ACTS(/*model*/ MODEL_RED_COIN,              /*pos*/ -6806,  188,  4653, /*angle*/ 0, 0, 0,   /*bhvParam*/ 0, /*bhv*/ bhvRedCoin,                /*acts*/ ACT_4),
    RETURN(),
};
