...
static const LevelScript script_func_local_1[] = {
    ...
    OBJECT          (/*model*/ MODEL_LEVEL_GEOMETRY_07, /*pos*/   0,   3519, -2800, /*angle*/ 0, 0, 0, /*bhvParam*/ 0, /*bhv*/ bhvStaticObject),
    OBJECT          (/*model*/ MODEL_LEVEL_GEOMETRY_0A, /*pos*/  3840,  794,  2688, /*angle*/ 0, 0, 0, /*bhvParam*/ 0, /*bhv*/ bhvStaticObject),
    OBJECT          (/*model*/ MODEL_LEVEL_GEOMETRY_0C, /*pos*/  1408, 2522,  2496, /*angle*/ 0, 0, 0, /*bhvParam*/ 0, /*bhv*/ bhvStaticObject),
    OBJECT          (/*model*/ MODEL_WF_GIANT_POLE,     /*pos*/  1128, 2560, -1024, /*angle*/ 0, 0, 0, /*bhvParam*/ 0, /*bhv*/ bhvGiantPole),
    OBJECT          (/*model*/ MODEL_WF_GIANT_POLE,     /*pos*/ -1213, 2560,  1850, /*angle*/ 0, 0, 0, /*bhvParam*/ 0, /*bhv*/ bhvGiantPole),
    RETURN(),
};

static const LevelScript script_func_local_2[] = {
    OBJECT          (/*model*/ MODEL_WF_SMALL_BOMP,               /*pos*/  3300, 1070,     1, /*angle*/ 0,  90, 0, /*behParam*/ 0, /*beh*/ bhvSmallBomp),
    OBJECT          (/*model*/ MODEL_WF_SMALL_BOMP,               /*pos*/  3300, 1070,  1281, /*angle*/ 0,  90, 0, /*behParam*/ 0, /*beh*/ bhvSmallBomp),
    OBJECT          (/*model*/ MODEL_WF_LARGE_BOMP,               /*pos*/  3300, 1070,   641, /*angle*/ 0,   0, 0, /*behParam*/ 0, /*beh*/ bhvLargeBomp),
    OBJECT          (/*model*/ MODEL_WF_ROTATING_WOODEN_PLATFORM, /*pos*/  -255, 2560,  2304, /*angle*/ 0,   0, 0, /*behParam*/ 0, /*beh*/ bhvWFRotatingWoodenPlatform),
    ...
    OBJECT          (/*model*/ MODEL_WF_TUMBLING_BRIDGE,          /*pos*/  1792, 2496,  1600, /*angle*/ 0,   0, 0, /*behParam*/ 0, /*beh*/ bhvTumblingBridge),
    RETURN(),
};
...
static const LevelScript script_func_local_3[] = {
	...
	OBJECT_WITH_ACTS(/*model*/ MODEL_RED_COIN,          /*pos*/  -250, 2650,  2970, /*angle*/ 0,    0, 0, /*bhvParam*/ 0, /*bhv*/ bhvRedCoin,                /*acts*/ ACT_6),
    OBJECT_WITH_ACTS(/*model*/ MODEL_RED_COIN,          /*pos*/  1746, 3620, -3120, /*angle*/ 0,    0, 0, /*bhvParam*/ 0, /*bhv*/ bhvRedCoin,                /*acts*/ ACT_6),
	OBJECT_WITH_ACTS(/*model*/ MODEL_RED_COIN,          /*pos*/  1277, 2600,  1350, /*angle*/ 0,    0, 0, /*bhvParam*/ 0, /*bhv*/ bhvRedCoin,                /*acts*/ ACT_6),
	OBJECT_WITH_ACTS(/*model*/ MODEL_RED_COIN,          /*pos*/  1585, 2595,   -80, /*angle*/ 0,    0, 0, /*bhvParam*/ 0, /*bhv*/ bhvRedCoin,                /*acts*/ ACT_6),
	OBJECT_WITH_ACTS(/*model*/ MODEL_RED_COIN,          /*pos*/  3350, 3000, -1520, /*angle*/ 0,    0, 0, /*bhvParam*/ 0, /*bhv*/ bhvRedCoin,                /*acts*/ ACT_6),
	OBJECT_WITH_ACTS(/*model*/ MODEL_RED_COIN,          /*pos*/  5836, 3706, -1445, /*angle*/ 0,    0, 0, /*bhvParam*/ 0, /*bhv*/ bhvRedCoin,                /*acts*/ ACT_6),
	OBJECT_WITH_ACTS(/*model*/ MODEL_RED_COIN,          /*pos*/  3770, 1380,   650, /*angle*/ 0,    0, 0, /*bhvParam*/ 0, /*bhv*/ bhvRedCoin,                /*acts*/ ACT_6),
	OBJECT_WITH_ACTS(/*model*/ MODEL_RED_COIN,          /*pos*/  -270, 1720,  2250, /*angle*/ 0,    0, 0, /*bhvParam*/ 0, /*bhv*/ bhvRedCoin,                /*acts*/ ACT_6),
    RETURN(),
};
...
static const LevelScript script_func_local_4[] = {
    ...
    OBJECT_WITH_ACTS(/*model*/ MODEL_STAR,  /*pos*/ -2495, 2015, -256, /*angle*/ 0, 0, 0, /*bhvParam*/ BPARAM1(STAR_INDEX_ACT_3), /*bhv*/ bhvStar,                 /*acts*/ ALL_ACTS),
    OBJECT_WITH_ACTS(/*model*/ MODEL_NONE,  /*pos*/  4600,  550, 2500, /*angle*/ 0, 0, 0, /*bhvParam*/ BPARAM1(STAR_INDEX_ACT_6), /*bhv*/ bhvHiddenRedCoinStar, /*acts*/ ACT_6),
    OBJECT_WITH_ACTS(/*model*/ MODEL_STAR,  /*pos*/   0, 3750,  -2800, /*angle*/ 0, 0, 0, /*bhvParam*/ BPARAM1(STAR_INDEX_ACT_5), /*bhv*/ bhvStar,                 /*acts*/ ALL_ACTS),
    OBJECT_WITH_ACTS(/*model*/ MODEL_STAR,  /*pos*/   -384, 3684,   6, /*angle*/ 0, 0, 0, /*bhvParam*/ BPARAM1(STAR_INDEX_ACT_4), /*bhv*/ bhvStar,                 /*acts*/ ACT_2 | ACT_3 | ACT_4 | ACT_5 | ACT_6),
